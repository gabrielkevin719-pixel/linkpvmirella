...
! function(t, e) {
    ...
    return function(t) {
        ...
        function Y(t) {
            return e = function(t) {
                return "object" == typeof t && (t = K(t)), encodeURIComponent((e = t.toString(), R(L(e))));
                var e
            }, n = {}, F(t, (function(t, r) {
                n[r] = e(t)
            })), n;
        ...
        function $(t) {
            ...
            return W((e = Y(r), n = [], F(e, (function(t, e) {
                n.push([e, t])
                    ...
                    switch (typeof r) {
                        case "object":
                            ...
                            if (e.push(r), n.push(o), "[object Array]" === Object.prototype.toString.apply(r))
                                for (c = [], i = 0; i < r.length; i += 1) c[i] = t(r[i], o + "[" + i + "]");
                            else
                                for (s in c = {}, r) Object.prototype.hasOwnProperty.call(r, s) && (c[s] = t(r[s], o + "[" + JSON.stringify(s) + "]"));
                            return c;
                        case "number":
                        case "string":
                        case "boolean":
            ...
            nt = function() {
                ...
                return t.prototype.send = function(t) {
                    if (!this.request) {
                        ...
                        this.request = Se.createScriptRequest(n), this.request.send(t)
                    }
                }, t.prototype.cleanup = function() {
        ...
        var Tt = _t,
            ...
            Ot = new(function(t) {
                ...
                return Pt(e, t), e.prototype.isOnline = function() {
            ...
            Et = function() {
                ...
                return t.prototype.createConnection = function(t, e, n, r) {
                    ...
                    var i = this.transport.createConnection(t, e, n, r),
                        s = null,
                        c = function() {
                            i.unbind("open", c), i.bind("closed", a), s = U.now()
                        },
                        a = function(t) {
                            if (i.unbind("closed", a), 1002 === t.code || 1003 === t.code) o.manager.reportDeath();
                ...
                return Xt(e, t), e.prototype.authorize = function(e, n) {
                    ...
                    if (this.key)
                        if (e.ciphertext && e.nonce) {
                            ...
                            if (r.length < this.nacl.secretbox.overheadLength) Z.error("Expected encrypted event ciphertext length to be " + this.nacl.secretbox.overheadLength + ", got: " + r.length);
                            else {
                                var o = Object(Ft.decode)(e.nonce);
                                if (o.length < this.nacl.secretbox.nonceLength) Z.error("Expected encrypted event nonce length to be " + this.nacl.secretbox.nonceLength + ", got: " + o.length);
                                else {
            ...
            return t.prototype.isSupported = function() {
                ...
                var s = U.now(),
                    c = o.pop().connect(t, (function r(i, a) {
                        i ? (ne(n), o.length > 0 ? (s = U.now(), c = o.pop().connect(t, r)) : e(i)) : (! function(t, e, n) {
                        ...
                        }(n, a.transport.name, U.now() - s), e(null, a))
                    }));
                return {
                    abort: function() {
                        c.abort()
        ...
        var ce, ae = function(t, e, n) {
                ...
                var i, s = Object.assign({}, e, {
                    ...
                    g = o("xdr_streaming", "xdr_streaming", 1, a, p),
                    v = o("xhr_polling", "xhr_polling", 1, a),
                    b = o("xdr_polling", "xdr_polling", 1, a),
                    m = new $t([l], u),
                    _ = new $t([f], u),
                    w = new $t([d], u),
                    S = new $t([new oe(se(y), y, g)], u),
                    k = new $t([new oe(se(v), v, b)], u),
                    C = new $t([new oe(se(S), new Kt([S, new re(k, {
                        delay: 4e3
                    })]), k)], u),
                    T = new oe(se(C), C, w);
        ...
        var ke = ge,
            ...
            Te = function() {
                ...
                return t.prototype.isSupported = function() {
                    ...
                    var n = this;
                    if (!this.isSupported()) return Pe(new w, e);
                    if (this.priority < t) return Pe(new v, e);
                    var r = !1,
